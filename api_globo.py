...
def DownloadMaterial(idMaterial, nomeArquivo, md5):
    ...
    print(url)
    r = requests.get(url,verify='C:\\Program Files\\Microsoft Office\\Office14\\Groove\\Certificates\\Verisign\\Components\\VeriSign_Class_3_Code_Signing_2001-4_CA.cer')
