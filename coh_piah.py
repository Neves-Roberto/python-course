...
<<<<<<< HEAD
    ...
    for texto in textos:
        ...
        print('Tamanho medio de palavras: ', wal)
        print('Relacao Type-Token: ', ttr)
        print('Razao Hapax Legomana: ', hlr)
        print('Complexidade media da sentenca: ', sac)
...
=======
>>>>>>> 3cefc76831cd13d128d4c4f8ea01fdea52f1af99
